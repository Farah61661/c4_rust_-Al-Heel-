...
/// Defines the set of recognizable tokens in the C4 language subset.
...
/// Represents the nodes in the Abstract Syntax Tree, the structure of a parsed C4 program
...
// Represents expressions in the Abstract Synatx Tree
#[derive(Debug, PartialEq)]
pub enum Expr {
...
impl VM {
    ...
    // Starts the execution loop of the virtual machine
...
/// Compiles and executes a `.c` file using the custom VM
fn main() {
